...
video from Johnny Lee. He wanted to create a program that uses wiimote and it's
...
To develop this software, other than Allegro and Wiiuse libraries, we used:
	-SVG (yes, SVG :-P) to make Xylo logo & Xylo icon
	-BATIK to convert Xylo logo from SVG to .tif
	-GIMP to convert Xylo logo from .tif to .tga, to make Wiiuse logo, Allegro
		logo, "Released under GPLv3" logo and to resize and edit the
		icon image and to build the Xylo.ico file, and also for some
		other graphics
	-Richard Sanders's GUS patches from Allegro site to obtain the
		vibraphone's wavetable
...
Wiiuse logo, Allegro logo, and "released under GPLv3" logo by Marco Mandrioli
